...
One line per ticket. Move between sections as status changes.
See `README.md` for the full system description.

Format: `**PREFIX-NNN** · <title> · \`model\` · <note>`
...
<!-- Tickets not yet ready — needs more definition or depends_on unfinished. -->

## In progress

<!-- Currently spawned tickets. -->

## Done

<!-- Completed tickets with their finish date. -->
**ADW-001** · Content & information architecture · `sonnet` · 2026-07-20
